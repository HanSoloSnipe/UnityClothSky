 ...
 */
    ...
    public class ObiSkinnedClothEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            () => {
                EditorGUILayout.PropertyField(stretchCompliance, new GUIContent("Stretch resistance"));
            ...
            () => {
                EditorGUILayout.PropertyField(bendCompliance, new GUIContent("Bend resistance"));
            ...
            () => {
                EditorGUILayout.PropertyField(tetherCompliance, new GUIContent("Tether resistance"));
